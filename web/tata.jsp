...
<h3>Choose your Car</h3>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
   <img src="pics/nano.jpg" alt="" style="width:100%">             
...
btn.onclick = function() {
    modal.style.display = "block";
     ...
     <span class="close" onclick="document.getElementById('myModal').style.display='none'">&times;</span>
      <img src="cars/nano.jpg" width="100%" height="100%">
    </div>
  ...
  <div class="carousel-inner">
    <div class="item active">
        <center> <img src="cars/tiago.jpg" alt="" ></center>
    </div>
...
<div class="col-sm-4">
 <div class="card">
     <img src="pics/tiago.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>TIAGO</h2>
    <p class="title">&#8377; 3.3 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
  <img src="pics/tigor.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>TIGOR</h2>
...
<td>419 Litres</td>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
    <img src="pics/bolt.jpg" alt="" style="width:100%">           
  <div class="container1">
    <h2>BOLT</h2>
...
<div class="col-sm-4">
 <div class="card">
  <img src="pics/indica.jpg" alt="" style="width:100%">  
  <div class="container1">
    <h2>INDICA</h2>
    <p class="title">&#8377; 5.13 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
     <img src="pics/indigo.jpg" alt="" style="width:100%">         
  <div class="container1">
    <h2>INDIGO</h2>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
    <img src="pics/zest.jpg" alt="" style="width:100%">           
  <div class="container1">
      <h2>ZEST</h2>
...
<div class="col-sm-4">
 <div class="card">
   <img src="pics/hexa.jpg" alt="" style="width:100%">  
  <div class="container1">
    <h2>HEXA</h2>
    <p class="title">&#8377; 12.0 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
      <img src="pics/safari.jpg" alt="" style="width:100%">        
  <div class="container1">
    <h2>SAFARI STORME</h2>
