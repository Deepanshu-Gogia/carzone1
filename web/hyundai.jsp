...
<h3>Choose your Car</h3>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
  <img src="pics/eon_1.png" alt="" style="width:100%">  
...
<div class="col-sm-4">
 <div class="card">
  <img src="pics/i10.jpg" alt="" style="width:100%">  
  <div class="container1">
    <h2>i10</h2>
    <p class="title">&#8377; 4.3 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
   <img src="pics/grandi10.jpg" alt="" style="width:100%">  
  <div class="container1">
    <h2>GRAND i10</h2>
...
<td>256 Litres</td>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
         <img src="pics/elitei20.jpg" alt="" style="width:100%">        
  <div class="container1">
    <h2>ELITE i20</h2>
...
<div class="col-sm-4">
 <div class="card">
     <img src="pics/xcent.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>XCENT</h2>
    <p class="title">&#8377; 5.38 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
               <img src="pics/i20 active.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>i20 ACTIVE</h2>
  ...
  <div class="row">
    <div class="col-sm-4">  
            <div class="card">
                <img src="pics/verna.jpg" alt="" style="width:100%">
  <div class="container1">
      <h2>VERNA</h2>
...
<div class="col-sm-4">
 <div class="card">
    <img src="pics/creta.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>CRETA</h2>
    <p class="title">&#8377; 9.3 Lakhs onwards</p>
      ...
      <div class="col-sm-4">
          <div class="card">
 <img src="pics/elantra.jpg" alt="" style="width:100%">
  <div class="container1">
    <h2>ELANTRA</h2>
...
<div class="col-sm-6">
 <div class="card">
     <img src="pics/santa.jpg" alt="" style="width:100%"> 
  <div class="container1">
    <h2>SANTA FE</h2>
