...
.bgimg-1 {
    ...
    background-image: url("pics/show.jpg");
    min-height: 88%;
...
.input-group-addon {
    ...
    <img src="pics/jsr.jpg" width="110" height="50" alt="Header Image" style="float: left;display: inline"/>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" >
    ...
    <span class="w3-jumbo w3-hide-small">Best Car Collection Zone</span>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Best Car Collection Zone</span>
