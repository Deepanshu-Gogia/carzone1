...
#pswd_info {
                        ...
                        <div id="login" class="animate form">
                            ...
                            <form id="loginForm" name="loginForm" action="hello.jsp" autocomplete="off" method="post" onsubmit="return show()"/>
                                ...
                                <p> 
                                    ...
                                    <input id = "email"  onchange="email_validate(this.value);" name="email"  type="email" placeholder="mymail@mail.com"/> 
  ...
  <p>
                                    ...
                                    <input id="phone" pattern="[0-9]{10}" onkeyup="validatephone(this);" name="phoneno" type="text" placeholder="eg. 9818045445"/>
                                </p>  
