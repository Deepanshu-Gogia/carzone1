...
#contact {
  ...
  <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
    <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge">Sale your Car</h1>
    <h5 class="w3-hide-large" style="white-space:nowrap">Sale your Car</h5>
    <h3 class="w3-hide-medium w3-hide-small">Feel FREE to list your car On This Site !</h3>
  </div>
...
<div class="stepwizard">
    <div class="stepwizard-row setup-panel">
        ...
        <form class="w3-container w3-card-4 w3-light-blue"  action="sellacar_project.jsp" method="post" role="form" autocomplete="off">
            ...
            <div class="col-md-12">
               ...
               <div class="status" id="status"></div>
                ...
                <div class="form-group">
                    ...
                    <input maxlength="10"  pattern="[0-9]{10}" onkeyup="validatephone(this);" id="phone" required="required" name="psignup" class="w3-input w3-border w3-round-xxlarge"  maxlength="100" type="text" class="form-control" placeholder="eg.9818045445"  />
                </div></div><br>
