<%-- 
    Document   : aboutus
    Created on : july 3, 2017, 1:00:50 AM
...
<div class="col-sm-8">
    ...
    <h3>
  JSR Car Zone is one of the best known name in dealing with automobiles of Exclusive collection.
    </h3>
    <img src="pics/logos.jpg">
</div>
       </div></div>     
    </div></div></div>
...
<div class="col-sm-4">
    <h4>Follow Us :</h4>
 <a href="https://www.facebook.com/deepanshu.gogia5" class= "social_icon"> <i class="fa fa-facebook"></i></a>
